                                            ...
                                            @if (auth()->check() && auth()->user()->isSupervisor())
                                                <a href="{{ route('profile.definir', $usuario->id) }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="dark" class="bi bi-person-badge"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                            d="M6.5 2a2.5 2.5 0 1 1 5 0 2.5 2.5 0 0 1-5 0zM4 7a4 4 0 1 1 8 0 4 4 0 0 1-8 0z" />
                                                        <path
                                                            d="M14 8a6 6 0 1 0-12 0 6 6 0 0 0 12 0zM5.5 10h5v1h-5v-1zm.5 2.5c0-.827.673-1.5 1.5-1.5s1.5.673 1.5 1.5v.5h-3v-.5zm-3-.5h1v1h-1v-1z" />
                                                    </svg> </a>
                                            @endif
                                                <form style="display:inline"
                                                    ...
                                                    <button type="submit" class="btn btn-outline-danger"
                                                        id="excluir">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="dark" class="bi bi-trash3"
                                                            viewBox="0 0 16 16">
                                                            <path
