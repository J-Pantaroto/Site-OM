...
function _buscar() {
  _buscar = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var pesquisa,
      escopo,
      url,
      resposta,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          escopo = _args.length > 1 && _args[1] !== undefined ? _args[1] : '';
          url = '';
          if (!(escopo === 'usuarios')) {
            _context.next = 7;
            break;
