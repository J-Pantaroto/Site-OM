...
if (rotaAtual === "register") {
  ...
  botao.addEventListener('click', function (event) {
    ...
    if (email.value.length <= 0) {
      var _mensagem = document.getElementById('erro-email');
      email.classList.add('invalido');
      _mensagem.style.color = 'red';
      _mensagem.textContent = 'Informe seu email';
      email.focus();
      camposValidos.email = false;
    }
    ...
    if (cpf_cnpj.value.length <= 0) {
      var _mensagem2 = document.getElementById('erro-cpf-cnpj');
      cpf_cnpj.classList.add('invalido');
      _mensagem2.style.color = 'red';
      _mensagem2.textContent = 'Informe seu CPF ou CNPJ';
      cpf_cnpj.focus();
      camposValidos.cpfCnpj = false;
    }
    ...
    if (password.value.length <= 0) {
      var _mensagem3 = document.getElementById('erro-senha');
      password.classList.add('invalido');
      _mensagem3.style.color = 'red';
      _mensagem3.textContent = 'Informe uma senha e após isso confirme sua senha';
      password.focus();
      camposValidos.senha = false;
    }
    ...
    if (password_confirmation.value.length <= 0) {
      var _mensagem4 = document.getElementById('erro-confirmar-senha');
  ...
  var _botao = document.getElementById('login');
  _botao.addEventListener('click', function (event) {
    event.preventDefault(); // Prevenir o envio do formulário
    var email = document.getElementById('email');
    var password = document.getElementById('password');
    // Validação de email
