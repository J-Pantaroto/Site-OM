...
function atualizarEstadoBotao() {
  var botaoRegistrar = document.getElementById('registrar');
  botaoRegistrar.disabled = !verificarFormulario();
}
if (rotaAtual === "register" || rotaAtual === "login") {
  var validarEmailFormato = function validarEmailFormato(email) {
    var regex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
  ...
  var iconeOcultar = document.getElementById('ocultar');
...
if (rotaAtual === "register") {
  var validarCelular = function validarCelular() {
    var celularValue = celularInput.value.replace(/\D/g, ''); // Remove caracteres não numéricos
  ...
  var mensagem = document.getElementById('erro-celular');
  ...
  celularInput.addEventListener('paste', function (e) {
    var pastedData = e.clipboardData.getData('Text').replace(/\D/g, ''); // Remove caracteres não numéricos
  ...
  document.getElementById('cpf_cnpj').addEventListener('input', function () {
    var cpf_cnpj = this.value.replace(/[^\d]+/g, '');
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var cpfCnpjValue = cpfCnpjField.value.replace(/[^\d]+/g, '');
  ...
  document.getElementById('name').addEventListener('input', function () {
    var mensagem = document.getElementById('erro-nome');
    mensagem.textContent = '';
    var nome = this;
    var nomeDigitado = nome.value;
    ...
    var nomeValido = /^[A-Za-zÀ-ÿ\s]+$/.test(nomeDigitado);
    if (!nomeValido) {
      mensagem.style.color = 'red';
    ...
    var nomeRepetido = /(.)\1{2,}/.test(nomeDigitado);
    if (nomeRepetido) {
      mensagem.style.color = 'red';
  ...
  var campoConfirmarSenha = document.getElementById('password_confirmation');
  var iconeOcultar2 = document.getElementById('confirmar-ocultar');
  ...
  nome.addEventListener('input', function () {
    if (nome.value.trim().length < 3) {
      var _mensagem = document.getElementById('erro-nome');
      nome.classList.add('invalido');
      _mensagem.style.color = 'red';
      _mensagem.textContent = 'Informe seu nome';
      nome.focus();
      camposValidos.nome = false;
      atualizarEstadoBotao();
    }
  ...
  email.addEventListener('input', function () {
    if (email.value.length <= 0) {
      var _mensagem2 = document.getElementById('erro-email');
      email.classList.add('invalido');
      _mensagem2.style.color = 'red';
      _mensagem2.textContent = 'Informe seu email';
      email.focus();
      camposValidos.email = false;
      atualizarEstadoBotao();
    }
  ...
  cpf_cnpj.addEventListener('input', function () {
    if (cpf_cnpj.value.length <= 0) {
      var _mensagem3 = document.getElementById('erro-cpf-cnpj');
      cpf_cnpj.classList.add('invalido');
      _mensagem3.style.color = 'red';
      _mensagem3.textContent = 'Informe seu CPF ou CNPJ';
      cpf_cnpj.focus();
      camposValidos.cpfCnpj = false;
      atualizarEstadoBotao();
    }
  ...
  password.addEventListener('input', function () {
    if (password.value.length <= 0) {
      var _mensagem4 = document.getElementById('erro-senha');
      password.classList.add('invalido');
      _mensagem4.style.color = 'red';
      _mensagem4.textContent = 'Informe uma senha e após isso confirme sua senha';
      password.focus();
      camposValidos.senha = false;
      atualizarEstadoBotao();
    }
  ...
  botao.addEventListener('click', function (event) {
    ...
    // Validação de email
    if (email.value.length <= 0) {
      var _mensagem5 = document.getElementById('erro-email');
      email.classList.add('invalido');
      _mensagem5.style.color = 'red';
      _mensagem5.textContent = 'Informe seu email';
      email.focus();
      camposValidos.email = false;
      atualizarEstadoBotao();
    }
...
if (rotaAtual === "password.reset") {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var submitButton = document.getElementById('registrar');
    var camposValidos = {
      senha: false,
    ...
    // Validação da senha
    password.addEventListener('input', function () {
      var mensagem = document.querySelector('.erro-senha') || document.createElement('div');
    ...
    passwordConfirmation.addEventListener('input', function () {
      var mensagem = document.querySelector('.erro-confirmar-senha') || document.createElement('div');
